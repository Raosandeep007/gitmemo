...
function UpdateCustomizedProfileDialog({ open, onOpenChange, onSuccess }: Props) {
  ...
  const [customProfile, setCustomProfile] = useState<CustomProfile>({
    title: generalSetting.customProfile?.title || "Memos",
  ...
  const setPartialState = (partialState: Partial<CustomProfile>) => {
  ...
  const handleSaveButtonClick = async () => {
    ...
    try {
      ...
      console.error("Update customized profile failed:", error);
