                ...
                <div className="flex flex-col p-0.5">
                  <div className="flex items-center justify-between border-b border-border pb-1 mb-1">
                    <span className="text-[10px] font-medium text-muted-foreground">
                      {memo.createTime &&
                        new Date(memo.createTime).toLocaleDateString(undefined, {
                          year: "numeric",
                          month: "short",
                          day: "numeric",
                        })}
                  ...
                  <div className="line-clamp-3 py-0.5 text-xs font-sans leading-snug text-foreground">
                    {memo.content.slice(0, 100) || "No content"}
                  </div>
                </div>
              </Popup>
            </Marker>
